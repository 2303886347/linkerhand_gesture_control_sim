...
当前注册已经验收通过的 L30 左右手，以及来自官方公开资源的 O6 左右手模型层。
重定向、RViz 和 Gazebo 继续使用同一个加载接口，不在各节点中新增型号判断分支。
...
o6_left = load_model_profile('o6', 'left')
print(o6_left.active_joints)  # 6 个主动自由度
print(o6_left.joint_limits['thumb_cmc_pitch'])  # 自动考虑 mimic 安全限位
```
